...
import com.digital.v3.dao.PhoneDAO;
...
public class PhoneService {
	...
	public boolean phoneWrite (Phone phone) throws Exception {
		try {
			// phone 중복 여부 확인
			if (phoneDAO.getPhoneByNumber(phone.getPhoneNumber()) != null) {
	...
	public Phone phoneSearch (String phoneNumber) throws Exception {
		...
		PhoneVO phoneVo = phoneDAO.getPhoneByNumber(phoneNumber);
